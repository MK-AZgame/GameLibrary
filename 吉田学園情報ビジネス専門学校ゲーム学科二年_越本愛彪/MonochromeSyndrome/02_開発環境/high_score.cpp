...
//グローバル変数
LPDIRECT3DTEXTURE9 g_pTextureHighScore = NULL;			//ハイスコアのテクスチャのポインタ
LPDIRECT3DVERTEXBUFFER9 g_pVtxBuffHighScore = NULL;		//ハイスコアの頂点情報のポインタ
...
void InitHighScore(void)
{
	...
	{
		//頂点座標の設定
		pVtx[0].pos = D3DXVECTOR3(570.0f + (60.0f * nCntTimer), 540.0f, 0.0f);
		pVtx[1].pos = D3DXVECTOR3(630.0f + (60.0f * nCntTimer), 540.0f, 0.0f);
		pVtx[2].pos = D3DXVECTOR3(570.0f + (60.0f * nCntTimer), 620.0f, 0.0f);
		pVtx[3].pos = D3DXVECTOR3(630.0f + (60.0f * nCntTimer), 620.0f, 0.0f);
